<!-- app/views/admin/subscriptions.php -->
...
<body>
    ...
    <div class="sidebar">
        ...
        <a href="/admin/subscriptions" class="active">🔄 Assinaturas</a>
    ...
    <div class="main-content">
        <div class="topbar">
            <h2>🔄 Assinaturas</h2>
            <span class="text-muted">Total: <?= count($subscriptions) ?> de <?= ceil($total / 20) * 20 ?></span>
        </div>
                    ...
                    <table class="table table-hover table-sm">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php if ($sub['renews_at']): ?>
                                    <?= date('d/m/Y', strtotime($sub['renews_at'])) ?>
                                    <?php else: ?>
    ...
    async function cancelSubscription(id) {
        ...
        const res = await fetch(`/admin/subscription/cancel?id=${id}`);
